...
'Description:   This form lists all the retired

Option Strict On

Public Class RetiredVehicles
    ...
    Private Sub RetiredVehicles_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
