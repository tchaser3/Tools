...
'Description:  This Form is used to view the Weekly Inspection Log

Option Strict On

Public Class ViewWeeklyInspectionLog
    ...
    Private Sub ViewWeeklyInspectionLog_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
