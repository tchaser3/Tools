'Title:         Cable Availability Report
'Date:          9/2/14
'Author:        Terry Holmes

'Description:   This form is used to run a cable availability report

Option Strict On

Public Class CableAvailabilityReport
    ...
    Private Sub SetControlsVisible(ByVal valueBoolean As Boolean)
        ...
        'This will make controls visible or invisible
    ...
    Private Sub CableAvailabilityReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
