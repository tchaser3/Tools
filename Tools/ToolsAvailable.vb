'Title:         Tools that are Available
'Date:          7/19/13
'Author:        Terry Holmes

'Descripton:    This form Shows all Available Tools
...
Public Class ToolsAvailable
    ...
    Private Sub SetTheToolForm()
        ...
        If mintCounter = 0 Then
            MessageBox.Show("There are Currently No Tools Available", "The form will close", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
    ...
    Private Sub ToolsAvailable_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
