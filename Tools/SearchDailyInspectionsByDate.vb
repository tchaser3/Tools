'Title:         Daily Inspection Log Date Search
'Date:          8/19/13
'Author:        Terry Holmes

'Description:   This form is where the date search information is displayed

Option Strict On

Public Class SearchDailyInspectionsByDate
    ...
    Private Sub btnSearchByEmployeeName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchByEmployeeName.Click
        ...
        If blnFatalError = True Then
            MessageBox.Show("Employee Last Name Was Not Entered", "Please Correct", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If blnFatalError = True Then
            MessageBox.Show("Employee's First Name was not Entered", "Please Correct", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        For intCounter = 0 To mintEmployeeIdUpperLimit - 1
            ...
            If strLastNameEntered = strLastNameFromTable Then
                ...
                If strFirstNameEntered = strFirstNameFromTable Then
                    If mdatDateFromTable >= mdatStartingDateForSearching And mdatDateFromTable <= mdatEndingDateForSearching Then
    ...
    Private Sub SearchDailyInspectionsByDate_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub txtFirstNameSearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFirstNameSearch.KeyDown
