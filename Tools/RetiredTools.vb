...
'Description:   This will display all retired tools

Option Strict On

Public Class RetiredTools
    ...
    Private Sub RetiredTools_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub SetTheToolForm()
        ...
        For intCounter = 0 To mintUpperLimit
            ...
            If (strActive = "NO" And strAvailable = "NO") Then
    ...
    Private Sub btnFindTool_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFindTool.Click
        ...
        Dim blnToolTypeCorrect As Boolean
        Dim strToolType As String

        strToolType = txtTypeOfTool.Text
        Logon.mstrToolCategory = strToolType
        ToolCategoryCheck.Show()
        blnToolTypeCorrect = Logon.mblnToolCategoryExists

        If blnToolTypeCorrect = False Then
            MessageBox.Show("The Tool Type Entered is not Correct", "Please Correct", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
