...
'Description:   This form is used for the initial twisted pair load
...
Public Class TwistedPair
    ...
    Private Sub TwistedPair_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            For intCounter = 0 To mintCableTypeComboBoxUpperLimit
                ...
                If strCategory = "TWISTED PAIR" Then
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Else  'This else statement runs when the record is saved
            ...
            strErrorMessage = "Part Number Information was not Entered"
            ...
            If blnFatalError = False Then
                ...
                strErrorMessage = "Current Footage is not an Integer"
