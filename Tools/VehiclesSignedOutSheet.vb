'Title:         Vehicle Sign Out Sheet Signe3d
'Date:          9/29/13
'Author;        Terry Holmes

'Description:   This form is used for Data Entry for the Sign Out Sheet

Option Strict On

Public Class VehiclesSignedOutSheet
    ...
    Private Sub VehiclesSignedOutSheet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub SetForPreLoad()
        ...
        intNumberOfRecords = cboTransactionID.Items.Count + 1000
    ...
    Private Sub SaveData()
        ...
        If mblnFatalError = False Then
            ...
            strErrorMessage = "BJC Number Does Not Exist"
        End If
        ...
        If mblnFatalError = False Then
            ...
            If mblnFatalError = False Then
                strValueForValidation = txtVehicleSignOutSheetSigned.Text
                strErrorMessage = "Vehicle Signed Out Sheet is not a Yes or No"
    ...
    Private Sub setControlsReadOnly(ByVal valueBoolean As Boolean)
        ...
        With Me
            ...
            txtVehicleSignOutSheetSigned.ReadOnly = valueBoolean
