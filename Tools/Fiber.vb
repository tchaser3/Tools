'Title:         Fiber Entry From
'Date:          1/3/14
'Author:        Terry Holmes

'Description:   This form is used for the initial inventory load
...
Public Class Fiber
    ...
    Dim mintEmployeeComboBoxUpperLimit As Integer
    ...
    Private Sub Fiber_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
